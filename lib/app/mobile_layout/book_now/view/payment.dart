              ...
              child: Padding(
                ...
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (bookContrlNow.totalAmount.value <= 0) {
                          Get.snackbar('select slot', 'Please select the slot');
                        } else {
                          bookContrlNow.paymentInitialize();
                        }
                      },
